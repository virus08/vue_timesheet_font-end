<template>
                <li class="active">
					<a href="index.html"><i class="fa fa-th-large"></i> <span class="nav-label">Main Application</span> <span class="fa arrow"></span></a>
					<ul class="nav nav-second-level">
						<li :class="{ active: location==='/home' }"><a href="/home">Home</a></li>
